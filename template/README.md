...
- `auth` + hub verification for signed POST payloads (overridable with `BYPASS_SIGNATURE_VERIFICATION` in dev)
...
- `POST /` accepts a signed snap interaction payload and returns the next page
