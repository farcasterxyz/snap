...
| 11  | [bar_chart](#bar-chart)       | Data      | Horizontal bar chart with labeled bars    |
| 12  | [cell_grid](#cell-grid)       | Data      | Colored cell grid, optionally interactive |
...
| 16  | [toggle_group](#toggle-group) | Field     | Single or multi-select choice group       |
