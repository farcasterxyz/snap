...
pagination bar. Buttons or tappable `cell_grid` cells inside the paginator can bind
local actions:
...
These actions affect only the nearest containing paginator and never submit POST input.
