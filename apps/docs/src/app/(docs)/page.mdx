...
> **Using Claude Code?** Install the snap generator skill and run `/create-farcaster-snap` to go from prompt to deployed snap. See the [Building a Snap](/building) guide for install instructions and all other approaches.
