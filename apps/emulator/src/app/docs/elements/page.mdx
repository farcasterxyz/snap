...
<div className="element-preview">
  <div style={{width: "100%", aspectRatio: "16/9", borderRadius: 10, background: "var(--bg-hover)", display: "flex", alignItems: "center", justifyContent: "center", color: "var(--text-faint)", fontSize: 13}}>
