...
<div className="element-preview">
  <img src="https://picsum.photos/seed/snap-docs/640/360" alt="Sample landscape" style={{width: "100%", borderRadius: 10, display: "block", aspectRatio: "16/9", objectFit: "cover"}} />
</div>
...
<div className="element-preview" style={{padding: 0, overflow: "hidden"}}>
  <div style={{position: "relative"}}>
    <img src="https://picsum.photos/seed/snap-video/640/360" alt="Video thumbnail" style={{width: "100%", display: "block", aspectRatio: "16/9", objectFit: "cover"}} />
    <div style={{position: "absolute", inset: 0, display: "flex", alignItems: "center", justifyContent: "center", background: "rgba(0,0,0,0.3)"}}>
      <div style={{width: 48, height: 48, borderRadius: "50%", background: "rgba(255,255,255,0.9)", display: "flex", alignItems: "center", justifyContent: "center"}}>
        <svg width="20" height="20" viewBox="0 0 24 24" fill="#111"><polygon points="6 3 20 12 6 21 6 3" /></svg>
      </div>
    </div>
  </div>
</div>
...
<div className="element-preview">
  <input type="text" placeholder="Type 5-letter word..." maxLength={5} style={{width: "100%", padding: "10px 12px", border: "1px solid var(--border)", borderRadius: 10, fontSize: 14, fontFamily: "inherit", background: "var(--input-bg, #fff)", color: "var(--text-primary)", boxSizing: "border-box", outline: "none"}} />
</div>
...
<SnapCard valid={true}>
  <div style={{fontSize: 22, fontWeight: 700, marginBottom: 8}}>Best sci-fi movies</div>
  <InteractiveButtonGroup options={["Arrival", "Dune", "Interstellar"]} />
  <div style={{fontSize: 12, color: "var(--text-muted)", marginTop: 8}}>Pick your favorite, then tap Vote</div>
  <div style={{marginTop: 12, padding: "10px 12px", borderRadius: 10, background: "#8B5CF6", color: "#fff", fontWeight: 600, fontSize: 14, textAlign: "center"}}>Vote</div>
</SnapCard>
...
```json
{
  ...
  "page": {
    ...
    "buttons": [
      { "label": "Vote", "action": "post", "target": "https://example.com/vote" }
    ]
  }
}
```
...
<SnapCard valid={false}>
  <div style={{width: "100%", aspectRatio: "16/9", borderRadius: 8, background: "var(--bg-hover)"}} />
</SnapCard>
...
**Fails:** First page must have at least one interactive element (`button_group`, `slider`, `text_input`, `toggle`) or media element (`image`, `video`, `grid`). Text-only pages are invalid.
...
<SnapCard valid={false}>
  ...
  <div style={{height: 6, borderRadius: 999, background: "var(--border)", marginTop: 6, overflow: "hidden"}}><div style={{height: "100%", width: "50%", background: "#8B5CF6"}} /></div>
  <div style={{fontSize: 12, marginTop: 6}}>1. Item 1</div>
  <input type="range" style={{width: "100%", marginTop: 6, accentColor: "#8B5CF6"}} />
  <div style={{fontSize: 12, color: "var(--text-muted)", marginTop: 4}}>Too many!</div>
  <div style={{fontSize: 10, color: "var(--text-faint)", marginTop: 4}}>6 elements — max is 5</div>
</SnapCard>
...
<SnapCard valid={false}>
  ...
  <div style={{width: "100%", aspectRatio: "16/9", borderRadius: 8, background: "var(--bg-hover)", marginBottom: 6}} />
  <div style={{width: "100%", aspectRatio: "16/9", borderRadius: 8, background: "var(--bg-hover)"}} />
  <div style={{fontSize: 10, color: "var(--text-faint)", marginTop: 6}}>2 images — max is 1 media element</div>
</SnapCard>
  ...
  "page": {
    "elements": {
      ...
      "children": [
        ...
        { "type": "image", "url": "https://example.com/b.jpg", "aspect": "16:9" }
      ]
    }
  }
}
...
**Fails:** Max 1 media element (`image`, `video`, or `grid`) per page.
...
<SnapCard valid={false}>
  ...
  <div style={{fontSize: 10, color: "var(--text-faint)", marginTop: 6}}>accent: "#8B5CF6" — must be "purple"</div>
</SnapCard>
