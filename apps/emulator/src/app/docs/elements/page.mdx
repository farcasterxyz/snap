...
> **Sample:** Open the [Element Showcase](https://farcaster.xyz/~/developers/snaps?url=https://snap-element-showcase.host.neynar.app/) in the emulator to interact with every element type.
